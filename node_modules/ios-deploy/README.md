ios-deploy
==========
Install and uninstall iOS apps without using Xcode. Designed to work on un-jailbroken devices.
...
## Usage
    ...
    Usage: ios-deploy [OPTION]...
      -d, --device <device_id>    the id of the device to connect to
      -p, --path <bundle.app>     the path to the app bundle to be installed
      -r, --reinstall             uninstall the app before install (do not use with -m; app cache and data are cleared)
      -b, --bundle <bundle id>    specify bundle id for list and upload
      -u, --uninstall             only uninstall the app with given bundle_id
      -i, --isinstalled           check if the app with given bundle_id is installed or not
